...
#______________________________ANA___________________________________________________
...
#dados extraidos [previamente da API]
...
")
      ...
      tabItem(tabName = "CompararPartidos", 
              ...
              fluidRow(
                ...
                box(plotlyOutput("gg2"), height = 450, width = 700, title = HTML(paste( HTML('&nbsp;'), HTML('&nbsp;'), "Percentual votos nos partidos por Estado"))),
